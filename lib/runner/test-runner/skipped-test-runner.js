...
const debug = require('debug')(`hermione:master:skipped-test-runner`);
...
module.exports = class SkippedTestRunner extends Runner {
    ...
    run() {
        debug(`run skipped test: ${this._test.fullTitle()}, disabled: ${this._test.disabled}, pending: ${this._test.disabled}`);
