...
const debug = require('debug')(`hermione:common:browser`);
...
module.exports = class Browser {
    ...
    setHttpTimeout(timeout) {
        ...
        debug(`set connectionRetryTimeout: ${timeout}`);
    ...
    _createSession() {
        ...
        debug(`before start create wdio session with waitTimeout: ${config.waitTimeout}, logLevel: ${this._debug}, connectionRetryTimeout: ${config.httpTimeout}`);
